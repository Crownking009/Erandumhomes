...
export const INITIAL_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    bedrooms: 3,
    bathrooms: 3,
    description: 'Bespoke 3-bedroom luxury apartment featuring 24/7 power, tennis court access, and premium en-suite bedrooms in a secure gated estate.',
    images: [
      'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1613490493576-7fde63acd811?auto=format&fit=crop&q=80&w=1200'
    ],
    videoUrl: '',
    amenities: ['24/7 Electricity', 'Tennis Court', 'Smart TV (Netflix)', 'Gated Estate', 'Washing Machine'],
    whatsappNumber: WHATSAPP_NUMBER,
    createdAt: Date.now(),
  },
  {
    id: '4',
    title: 'Blue Waters Azure Suite',
    ...
    bedrooms: 2,
    bathrooms: 2,
    description: 'Breathtaking 7th-floor city view apartment in the prestigious Blue Waters Oniru. Features a curated interior, swimming pool, gym, and optional PS5 for the ultimate leisure experience.',
    images: [
      'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&q=80&w=1200'
    ],
    videoUrl: '',
    amenities: ['City View', 'Swimming Pool', 'Gym', 'PS5 Available', 'Elevator', '24/7 Security'],
    whatsappNumber: WHATSAPP_NUMBER,
    createdAt: Date.now(),
  },
  {
    id: '5',
    title: 'The Zen Haven Lekki',
    location: 'Lekki Phase 1, Lagos',
    price: 155000,
    type: PropertyType.APARTMENT,
    category: ListingCategory.SHORT_LET,
    ...
    bedrooms: 3,
    bathrooms: 3,
    description: 'Experience tranquility in this 3-bedroom masterpiece. Located in a secure estate with tennis court access, mini supermarket, and premium en-suite rooms designed for relaxation.',
    images: [
      'https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&q=80&w=1200'
    ],
    videoUrl: '',
    amenities: ['Tennis Court', 'Mini Supermarket', 'Smart Home', 'Chef Available', 'Fibre Internet'],
    whatsappNumber: WHATSAPP_NUMBER,
    createdAt: Date.now(),
  },
  {
    id: '6',
    title: 'Sky-High Penthouse VI',
    location: 'Victoria Island, Lagos',
    price: 250000,
    type: PropertyType.PENTHOUSE,
    category: ListingCategory.SHORT_LET,
    ...
    bedrooms: 3,
    bathrooms: 3.5,
    description: 'Ultimate luxury overlooking Victoria Island. This penthouse features a snooker table, PS5, double living area, and unmatched views. The pinnacle of short-let hospitality.',
    images: [
      'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1600607687940-4e5a994239b7?auto=format&fit=crop&q=80&w=1200'
    ],
    videoUrl: '',
    amenities: ['Snooker Table', 'Panoramic Views', 'PS5 Included', 'Private Butler', 'Luxury Decor'],
    whatsappNumber: WHATSAPP_NUMBER,
    createdAt: Date.now(),
  }
];
